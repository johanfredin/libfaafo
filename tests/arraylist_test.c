...
void test_new(void) {
    ...
    TEST_ASSERT_EQUAL_INT(ARRAYLIST_DEFAULT_CAPACITY, ArrayList_capacity(list));
    TEST_ASSERT_EQUAL_PTR(free, ArrayList_get_df(list));
    TEST_ASSERT_EQUAL_INT(0, ArrayList_size(list));
}

void test_create(void) {
    list = ArrayList_create(20, Commons_bstring_destroy);
    TEST_ASSERT_NOT_NULL(list);
    TEST_ASSERT_EQUAL_INT(20, ArrayList_capacity(list));
    TEST_ASSERT_EQUAL_INT(0, ArrayList_size(list));
    TEST_ASSERT_EQUAL_PTR(Commons_bstring_destroy, ArrayList_get_df(list));
}

void test_add_no_resize_needed(void) {
    // Set up
    list = ArrayList_create(ARRAYLIST_DEFAULT_CAPACITY, Commons_bstring_destroy);
    ...
    // Verify
    TEST_ASSERT_EQUAL_INT(ARRAYLIST_DEFAULT_CAPACITY, ArrayList_size(list));
    TEST_ASSERT_EQUAL_INT_MESSAGE(ARRAYLIST_DEFAULT_CAPACITY, ArrayList_capacity(list), "List capacity was altered");
...
void test_add_resize_needed(void) {
    ...
    // Verify
    TEST_ASSERT_EQUAL_INT(expected_new_size, ArrayList_size(list));
    TEST_ASSERT_EQUAL_INT(new_cap + 9, ArrayList_capacity(list));
    for (int i = 0; i < ArrayList_size(list); i++) {
        bstring val = ArrayList_get(list, i);
        bstring expected = bformat("value %d", i);
        TEST_ASSERT_EQUAL_STRING(expected->data, val->data);
...
void test_set_get(void) {
    ...
    TEST_ASSERT_EQUAL_INT(1, ArrayList_size(list));
...
void test_remove(void) {
    ...
    TEST_ASSERT_EQUAL_INT_MESSAGE(ARRAYLIST_DEFAULT_CAPACITY, ArrayList_capacity(list),
                                  "Capacity changed should not be the case");
    TEST_ASSERT_EQUAL_INT_MESSAGE(ARRAYLIST_DEFAULT_CAPACITY - 1, ArrayList_size(list), "Size should be reduced by 1");
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE("value 6", ((bstring)ArrayList_get(list, 5))->data,
...
void test_size(void) {
    ...
    bstring val2 = bfromcstr("value2");
    TEST_ASSERT_EQUAL_INT(0, ArrayList_size(list));
    ArrayList_add(list, bfromcstr("value1"));
    ArrayList_add(list, val2);
    TEST_ASSERT_EQUAL_INT(2, ArrayList_size(list));

    ArrayList_remove(list, ArrayList_index_of(list, val2));
    TEST_ASSERT_EQUAL_INT(1, ArrayList_size(list));
    bdestroy(val2);
}
...
void test_is_empty(void) {
    ...
    TEST_ASSERT_TRUE(ArrayList_is_empty(list));
    ArrayList_add(list, bfromcstr("value1"));
    TEST_ASSERT_FALSE(ArrayList_is_empty(list));
}
...
void test_fist_last(void) {
    ...
    TEST_ASSERT_NULL(ArrayList_last(list));
    bstring s1 = bfromcstr("value1");
    bstring s2 = bfromcstr("value2");
    bstring s3 = bfromcstr("value3");
    ArrayList_add(list, s1);
    ArrayList_add(list, s2);
    ArrayList_add(list, s3);
    TEST_ASSERT_EQUAL_PTR(s3, ArrayList_last(list));
    TEST_ASSERT_EQUAL_PTR(s1, ArrayList_first(list));
}
...
void test_last_index(void) {
    ...
    bstring val2 = bfromcstr("value2");
    TEST_ASSERT_EQUAL_INT(-1, ArrayList_last_index(list));
    ArrayList_add(list, bfromcstr("value1"));
    ArrayList_add(list, val2);
    TEST_ASSERT_EQUAL_INT(1, ArrayList_last_index(list));
    ArrayList_remove(list, ArrayList_index_of(list, val2));
    TEST_ASSERT_EQUAL_INT(0, ArrayList_last_index(list));
    bdestroy(val2);
}
...
void test_clear(void) {
    ...
    list = ArrayList_new();
    for (int i = 0; i < ARRAYLIST_DEFAULT_CAPACITY; i++) {
        ArrayList_add(list, TestUtil_allocate_int(i));
    }
    TEST_ASSERT_EQUAL_INT(ARRAYLIST_DEFAULT_CAPACITY, ArrayList_size(list));
    ...
    TEST_ASSERT_EQUAL_INT(0, ArrayList_size(list));
    for (int i = 0; i < ARRAYLIST_DEFAULT_CAPACITY; i++) {
        TEST_ASSERT_NULL(ArrayList_get(list, i)); // Contents in array should be empty
    }
}
...
void test_sort_strings(void) {
    ...
    ArrayList_add_all(list, values, 3);

    // Verify not sorted
    TEST_ASSERT_EQUAL_STRING("Johan", ((bstring)(ArrayList_get(list, 0)))->data);
    TEST_ASSERT_EQUAL_STRING("Julia", ((bstring)(ArrayList_get(list, 1)))->data);
    ...
    TEST_ASSERT_EQUAL_STRING("Evelyn", ((bstring)(ArrayList_get(list, 0)))->data);
    TEST_ASSERT_EQUAL_STRING("Johan", ((bstring)(ArrayList_get(list, 1)))->data);
    TEST_ASSERT_EQUAL_STRING("Julia", ((bstring)(ArrayList_get(list, 2)))->data);
}

void test_sort_ints(void) {
    list = ArrayList_create(ARRAYLIST_DEFAULT_CAPACITY, free);
    void *values[] = {
    ...
    // Verify not sorted
    TEST_ASSERT_EQUAL_INT(30, deref_int(ArrayList_get(list, 0)));
    TEST_ASSERT_EQUAL_INT(90, deref_int(ArrayList_get(list, 1)));
    ...
    TEST_ASSERT_EQUAL_INT(0, sort);
    TEST_ASSERT_EQUAL_INT(30, deref_int(ArrayList_get(list, 0)));
    TEST_ASSERT_EQUAL_INT(60, deref_int(ArrayList_get(list, 1)));
    TEST_ASSERT_EQUAL_INT(90, deref_int(ArrayList_get(list, 2)));
